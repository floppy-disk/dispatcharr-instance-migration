...
Migrates state from a dev Dispatcharr instance to prod via the backup/restore API. Single Python script designed to run from Komodo or the command line.
